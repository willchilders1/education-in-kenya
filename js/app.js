(function () {
  ...
  function sequenceUI(girlsLayer, boysLayer) {
    ...
    sliderControl.onAdd = function (map) {
      ...
      // const classes = L.DomUtil.get("class");
    ...
    $('#slider input[type=range]')
      .on('input', function () {
        ...
        // Enter the element with the ID "grade"
        // Enter the h3 element
        // Enter the span element
        // Write the current grade
        $('#grade h3 span').html(currentGrade); // update the map with current timestamp
      });
    // $(".grade-slider")
    //   .on("input change", function () { // when user changes
    //     const currentGrade = this.value; // update the grade
    //     $('.grade-slider h3 span').html(currentGrade); // update the map with current timestamp
    //   });
  }
